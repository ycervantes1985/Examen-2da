...
const Update = () => {
  ...
  return (
    <div>
      ...
      {
        cancion&&
        <CancionForm nombre={cancion.nombre} tipo={cancion.tipo} descripcion={cancion.descripcion} compositor1={cancion.compositores[0]} compositor2={cancion.compositores[1]} compositor3={cancion.compositores[2]} onSubmitProp={updateCancion} action={"ACTUALIZAR"}/>
      }
